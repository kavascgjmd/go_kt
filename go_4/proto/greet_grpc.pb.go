...
type GreetServiceClient interface {
	...
	SayHelloBidrectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error)
}
...
func (c *greetServiceClient) SayHelloBidrectionalStreaming(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], GreetService_SayHelloBidrectionalStreaming_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBidrectionalStreamingClient = grpc.BidiStreamingClient[HelloRequest, HelloResponse]
...
type GreetServiceServer interface {
	...
	SayHelloBidrectionalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error
...
func (UnimplementedGreetServiceServer) SayHelloBidrectionalStreaming(grpc.BidiStreamingServer[HelloRequest, HelloResponse]) error {
...
func _GreetService_SayHelloBidrectionalStreaming_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloBidrectionalStreaming(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloBidrectionalStreamingServer = grpc.BidiStreamingServer[HelloRequest, HelloResponse]
